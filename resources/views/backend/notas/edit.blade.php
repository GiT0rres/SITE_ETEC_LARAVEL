    ...
    <form method="POST" action="{{ route('backend.notas.update', $nota) }}">
        ...
        <div class="filtros-bar">
            ...
            <div class="form-group">
                ...
                <input type="number" name="prova1" step="0.1" min="0" max="10" class="form-control" value="{{ old('prova1', $nota->prova1) }}">
            </div>
            {{-- Campo prova 2 --}}
            <div class="form-group">
                <label class="form-label">Prova 2</label>
                <input type="number" name="prova2" step="0.1" min="0" max="10" class="form-control" value="{{ old('prova2', $nota->prova2) }}">
            </div>
            {{-- Campo trabalho --}}
            <div class="form-group">
                <label class="form-label">Trabalho</label>
                <input type="number" name="trabalho" step="0.1" min="0" max="10" class="form-control" value="{{ old('trabalho', $nota->trabalho) }}">
            </div>
            {{-- Botão salvar --}}
