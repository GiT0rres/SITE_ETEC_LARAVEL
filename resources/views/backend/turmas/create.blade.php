...
<form method="POST"
      action="{{ route('backend.turmas.store') }}"
    ...
    <!-- Campo: período da turma -->
    <div class="form-group">
        <label class="form-label">Período</label>

        <select name="periodo" class="form-control">
            <option value="manha"
                {{ old('periodo') == 'manha' ? 'selected' : '' }}>
                Manhã
            </option>

            <option value="tarde"
                {{ old('periodo') == 'tarde' ? 'selected' : '' }}>
                Tarde
            </option>

            <option value="noite"
                {{ old('periodo') == 'noite' ? 'selected' : '' }}>
                Noite
            </option>
        </select>
    </div>
    ...
    <!-- Campo: upload da imagem da turma -->
    <div class="form-group">
